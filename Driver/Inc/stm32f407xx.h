...
//BIT DEFINE FOR SPI ON RCC_APB1ENR AND RCC_APB2ENR
#define RCC_APB2ENR_SPI1_POS	12
#define RCC_APB2ENR_SPI1		(1<< RCC_APB2ENR_SPI1_POS)
#define RCC_APB1ENR_SPI2_POS	14
#define RCC_APB1ENR_SPI2		(1<< RCC_APB1ENR_SPI2_POS)
#define RCC_APB1ENR_SPI3_POS	15
#define RCC_APB1ENR_SPI3		(1<< RCC_APB1ENR_SPI3_POS)
//SPI ENABLE CLOCK
#define SPI1_PERIPH_CLK_EN()	SET_BIT((*RCC).APB2ENR,RCC_APB2ENR_SPI1)
#define SPI2_PERIPH_CLK_EN()	SET_BIT((*RCC).APB1ENR,RCC_APB1ENR_SPI2)
#define SPI3_PERIPH_CLK_EN()	SET_BIT((*RCC).APB1ENR,RCC_APB1ENR_SPI3)
//SPI DISABLE CLOCK
#define SPI1_PERIPH_CLK_DI()	CLEAR_BIT((*RCC).APB2ENR,RCC_APB2ENR_SPI1)
#define SPI2_PERIPH_CLK_DI()	CLEAR_BIT((*RCC).APB1ENR,RCC_APB1ENR_SPI2)
#define SPI3_PERIPH_CLK_DI()	CLEAR_BIT((*RCC).APB1ENR,RCC_APB1ENR_SPI3)

//BIT DEFINE FOR GPIO ON RCC_AHB1ENR
#define RCC_AHB1ENR_GPIOA_POS            0
#define RCC_AHB1ENR_GPIOA             	(1<< RCC_AHB1ENR_GPIOA_POS)
#define RCC_AHB1ENR_GPIOB_POS            1
#define RCC_AHB1ENR_GPIOB             	(1<< RCC_AHB1ENR_GPIOB_POS)
#define RCC_AHB1ENR_GPIOC_POS            2
#define RCC_AHB1ENR_GPIOC             	(1<< RCC_AHB1ENR_GPIOC_POS)
#define RCC_AHB1ENR_GPIOD_POS            3
#define RCC_AHB1ENR_GPIOD             	(1<< RCC_AHB1ENR_GPIOD_POS)
#define RCC_AHB1ENR_GPIOE_POS            4
#define RCC_AHB1ENR_GPIOE             	(1<< RCC_AHB1ENR_GPIOE_POS)
#define RCC_AHB1ENR_GPIOF_POS            5
#define RCC_AHB1ENR_GPIOF             	(1<< RCC_AHB1ENR_GPIOF_POS)
#define RCC_AHB1ENR_GPIOG_POS            6
#define RCC_AHB1ENR_GPIOG             	(1<< RCC_AHB1ENR_GPIOG_POS)
#define RCC_AHB1ENR_GPIOH_POS            7
#define RCC_AHB1ENR_GPIOH             	(1<< RCC_AHB1ENR_GPIOH_POS)
#define RCC_AHB1ENR_GPIOI_POS            8
#define RCC_AHB1ENR_GPIOI             	(1<< RCC_AHB1ENR_GPIOI_POS)
...
#define RCC_APB1RSTR_SPI2             	(1<< RCC_APB1RSTR_SPI2_POS)
#define RCC_APB1RSTR_SPI3_POS            15
#define RCC_APB1RSTR_SPI3             	(1<< RCC_APB1RSTR_SPI3_POS)
#define RCC_APB2RSTR_SPI1_POS            12
#define RCC_APB2RSTR_SPI1             	(1<< RCC_APB2RSTR_SPI1_POS)
//GPIO ENABLE CLOCK
#define GPIOA_PERIPH_CLK_EN()   		SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOA)
#define GPIOB_PERIPH_CLK_EN()  			SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOB)
#define GPIOC_PERIPH_CLK_EN()  			SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOC)
#define GPIOD_PERIPH_CLK_EN()   		SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOD)
#define GPIOE_PERIPH_CLK_EN()  		 	SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOE)
#define GPIOF_PERIPH_CLK_EN()   		SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOF)
#define GPIOG_PERIPH_CLK_EN()   		SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOG)
#define GPIOH_PERIPH_CLK_EN()   		SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOH)
#define GPIOI_PERIPH_CLK_EN()   		SET_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOI)
//GPIO DISABLE CLOCK
#define GPIOA_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOA)
#define GPIOB_PERIPH_CLK_DI()  			CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOB)
#define GPIOC_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOC)
#define GPIOD_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOD)
#define GPIOE_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOE)
#define GPIOF_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOF)
#define GPIOG_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOG)
#define GPIOH_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOH)
#define GPIOI_PERIPH_CLK_DI()   		CLEAR_BIT((*RCC).AHB1ENR,RCC_AHB1ENR_GPIOI)
//GPIO RESET REGISTER
...
//SPI RESET REGISTER
#define SPI1_REG_RESET()       		do{SET_BIT((*RCC).APB2RSTR,RCC_APB2RSTR_SPI1); CLEAR_BIT((*RCC).APB2RSTR,RCC_APB2RSTR_SPI1); }while(0)
#define SPI2_REG_RESET()       		do{SET_BIT((*RCC).APB1RSTR,RCC_APB1RSTR_SPI2); CLEAR_BIT((*RCC).APB1RSTR,RCC_APB1RSTR_SPI2); }while(0)
#define SPI3_REG_RESET()       		do{SET_BIT((*RCC).APB1RSTR,RCC_APB1RSTR_SPI3); CLEAR_BIT((*RCC).APB1RSTR,RCC_APB1RSTR_SPI3); }while(0)
